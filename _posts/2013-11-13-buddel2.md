...
{% image buddel4.jpg "Aufgetakelt" "break" %}
Fertig getakelt und mit aufgerichteten Masten - fesch. Beim Anbringen der Takelage (die ~~Taue~~ Fitzelfäden, mit denen Masten und Segel gehalten werden) habe ich mich ein wenig mitreißen lassen – jeder Mast ist mit drei bis fünf der Dinger am Bug befestigt und die Rahen (an die die Segel gehängt werden) noch mit jeweils zwei – offenbar mag ich so kleine Tüddelsachen :)
{% endimage %}

<div class="swipeshow">
<div class="slides">
{% image buddel5.jpg "Aufgetakelt" "slide" %}
...
{% image http://www.rickmer-rickmers.de/uploads/RTEmagicC_takelplan-rickmer-rickmers_03.gif.gif "Takelplan der Rickmer Rickmers" "break" %}
