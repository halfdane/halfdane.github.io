        ...
        fn.push.apply(this, !s ?
                ...
                s.nodeType || s == window ?
                        ...
                        "" + s === s ?
                                /</.test(s)
                                        ?
                                        ( ( i = document.createElement(context || 'q') ).innerHTML = s, i.children ) :
                                        (context && $$(context)[0] || document).querySelectorAll(s) :
                                /f/.test(typeof s) ?
    ...
    $$.i[l = 'prototype'] = ( $$.extend = function (obj) {
        ...
        on: function (n, f) {
            ...
            this.map(function (item) {
                ...
                // nsRegAndEvents[ i ] is array of events (eg all click events for element#75) ([[namespace, handler],
                // [namespace, handler]])
